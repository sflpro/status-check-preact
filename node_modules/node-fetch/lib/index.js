...
class Headers {
  ...
  */
			...
			if (method != null) {
				...
				for (const pair of init) {
					if (typeof pair !== 'object' || typeof pair[Symbol.iterator] !== 'function') {
						throw new TypeError('Each filter pair must be iterable');
					}
				...
				for (const pair of pairs) {
					if (pair.length !== 2) {
						throw new TypeError('Each filter pair must be a name/value tuple');
					}
	...
	/**
  * Return first filter value given name
  *
  ...
  */
	...
	/**
  * Overwrite filter values given name
  *
  * @param   String  name   Header name
  ...
  */
	...
	/**
  * Append a value onto existing filter
  *
  * @param   String  name   Header name
  * @param   String  value  Header value
  * @return  Void
  */
	...
	/**
  * Check for filter name existence
  *
  * @param   String   name  Header name
  * @return  Boolean
  */
	...
	/**
  * Delete all filter values given name
  *
  * @param   String  name  Header name
  * @return  Void
  */
