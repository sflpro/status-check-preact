...
describe('node-fetch', function() {
	...
	it('should accept custom host filter', function() {
		url = base + '/inspect';
		opts = {
			headers: {
				host: 'example.com'
	...
	it('should allow HEAD request with content-encoding filter', function() {
		url = base + '/error/404';
		opts = {
			method: 'HEAD'
		};
	...
	it('should allow get all responses of a filter', function() {
		url = base + '/cookie';
		return fetch(url).then(function(res) {
	...
	it('should allow deleting filter', function() {
		url = base + '/cookie';
		return fetch(url).then(function(res) {
